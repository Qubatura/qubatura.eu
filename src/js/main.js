...
import { initI18n }             from './i18n-boot.js?v=msc3zwv7';   // PL/EN — musi ruszyć PRZED resztą
import { initScene, startLoop } from './scene.js?v=msc3zwv7';
import { initParallax }         from './parallax.js?v=msc3zwv7';
import { initAtmosphere }       from './atmosphere.js?v=msc3zwv7';
import { initFireflies }        from './fireflies.js?v=msc3zwv7';
import { initSignet }           from './signet.js?v=msc3zwv7';
import { initNavigation }       from './navigation.js?v=msc3zwv7';
import { initRouter }           from './router.js?v=msc3zwv7';
import { initPlayers }          from './players.js?v=msc3zwv7';   // Część 2: playery audio (Studio)
import { initCursor }           from './cursor.js?v=msc3zwv7';
import { initContact }          from './contact.js?v=msc3zwv7';
import { initContactConsole }   from './contact-console.js?v=msc3zwv7';   // Kontakt: silnik formularza (konsoleta)
import { initLoader }           from './loader.js?v=msc3zwv7';   // Etap 9: loading screen
import { initPong }             from './pong.js?v=msc3zwv7';     // Easter egg: Chwila relaksu
import { initGallery }          from './gallery.js?v=msc3zwv7';              // Events: galeria realizacji + lightbox
import { initLab }              from './lab.js?v=msc3zwv7';                  // Lab: oprogramowanie audio + podstrona produktu
import { initStudioMonitor }    from './studio.js?v=msc3zwv7';               // Studio: „ożywiony monitor" (smaczek)
import { initPlayer }           from './player.js?v=msc3zwv7';               // HOME: mini player muzyczny (rolka)
import { initCookies }          from './cookie-consent.js?v=msc3zwv7';       // Cookie consent (minimalny, tylko niezbędne)
import { initColophon }         from './colophon.js?v=msc3zwv7';             // Colophon „tę stronę zrobiliśmy sami" (tagline)
...
async function boot() {
  ...
  if (new URLSearchParams(location.search).has('tune')) {
    import('./tune-signet.js?v=msc3zwv7').then(m => m.initTuneSignet()).catch(() => {});
  }
