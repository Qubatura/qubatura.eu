...
import { initI18n }             from './i18n-boot.js?v=msc3w2im';   // PL/EN — musi ruszyć PRZED resztą
import { initScene, startLoop } from './scene.js?v=msc3w2im';
import { initParallax }         from './parallax.js?v=msc3w2im';
import { initAtmosphere }       from './atmosphere.js?v=msc3w2im';
import { initFireflies }        from './fireflies.js?v=msc3w2im';
import { initSignet }           from './signet.js?v=msc3w2im';
import { initNavigation }       from './navigation.js?v=msc3w2im';
import { initRouter }           from './router.js?v=msc3w2im';
import { initPlayers }          from './players.js?v=msc3w2im';   // Część 2: playery audio (Studio)
import { initCursor }           from './cursor.js?v=msc3w2im';
import { initContact }          from './contact.js?v=msc3w2im';
import { initContactConsole }   from './contact-console.js?v=msc3w2im';   // Kontakt: silnik formularza (konsoleta)
import { initLoader }           from './loader.js?v=msc3w2im';   // Etap 9: loading screen
import { initPong }             from './pong.js?v=msc3w2im';     // Easter egg: Chwila relaksu
import { initGallery }          from './gallery.js?v=msc3w2im';              // Events: galeria realizacji + lightbox
import { initLab }              from './lab.js?v=msc3w2im';                  // Lab: oprogramowanie audio + podstrona produktu
import { initStudioMonitor }    from './studio.js?v=msc3w2im';               // Studio: „ożywiony monitor" (smaczek)
import { initPlayer }           from './player.js?v=msc3w2im';               // HOME: mini player muzyczny (rolka)
import { initCookies }          from './cookie-consent.js?v=msc3w2im';       // Cookie consent (minimalny, tylko niezbędne)
import { initColophon }         from './colophon.js?v=msc3w2im';             // Colophon „tę stronę zrobiliśmy sami" (tagline)
...
async function boot() {
  ...
  if (new URLSearchParams(location.search).has('tune')) {
    import('./tune-signet.js?v=msc3w2im').then(m => m.initTuneSignet()).catch(() => {});
  }
