...
import { initScene, startLoop } from './scene.js?v=20260702g';
import { initParallax }         from './parallax.js?v=20260702g';
import { initAtmosphere }       from './atmosphere.js?v=20260702g';
import { initFireflies }        from './fireflies.js?v=20260702g';
import { initSignet }           from './signet.js?v=20260702g';
import { initNavigation }       from './navigation.js?v=20260702g';
import { initRouter }           from './router.js?v=20260702g';
import { initPlayers }          from './players.js?v=20260702g';   // Część 2: playery audio (Studio)
import { initCursor }           from './cursor.js?v=20260702g';
import { initContact }          from './contact.js?v=20260702g';
import { initLoader }           from './loader.js?v=20260702g';   // Etap 9: loading screen
import { initPong }             from './pong.js?v=20260702g';     // Easter egg: Chwila relaksu
import { initGallery }          from './gallery.js?v=20260702g';              // Events: galeria realizacji + lightbox
import { initLab }              from './lab.js?v=20260702g';                  // Lab: oprogramowanie audio + podstrona produktu
